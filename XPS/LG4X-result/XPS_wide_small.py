...
axis1.annotate('C-O', xy=(532.8, 5500-2*os1_sh-4100), xytext=(534, 5500-2*os1_sh-1300),horizontalalignment='center',arrowprops=dict(arrowstyle="->",facecolor='black'), fontsize=label_size)
...
axis1.annotate('C-O', xy=(532.8, 5500-3*os1_sh-4200), xytext=(534, 5500-3*os1_sh-1300),horizontalalignment='center',arrowprops=dict(arrowstyle="->",facecolor='black'), fontsize=label_size)
...
axis1.text(537, 2000, 'UT', color='black',horizontalalignment='center',verticalalignment='center', fontsize=label_size)
axis1.text(537, 2000-os1_sh, 'HT', color='black',horizontalalignment='center',verticalalignment='center', fontsize=label_size)
axis1.text(537, 2000-2*os1_sh, 'MX-0.1', color='black',horizontalalignment='center',verticalalignment='center', fontsize=label_size)
axis1.text(537, 2000-3*os1_sh, 'MX-0.5', color='black',horizontalalignment='center',verticalalignment='center', fontsize=label_size)
...
ax3.text(689, 8500, 'MX-0.1', color='black',horizontalalignment='center',verticalalignment='center', fontsize=label_size)
ax3.text(689, 2500, 'MX-0.5', color='black',horizontalalignment='center',verticalalignment='center', fontsize=label_size)


axis_name4 = 'ax' + '4'
axis4 = globals()[axis_name4]
bind, count, bg,sum_fit,residual, std_res = plot_xps('MX-UT-0.1-Cl2p',axis4,150,0)
ax4.annotate('Ti-Cl (2p$_{3/2}$)', xy=(198.9, 300), xytext=(197,400),horizontalalignment='center',arrowprops=dict(arrowstyle="->",facecolor='black'), fontsize=label_size)
...
ax4.annotate('Ti-Cl (2p$_{3/2}$)', xy=(198.9, 300-1000), xytext=(197,400-1000),horizontalalignment='center',arrowprops=dict(arrowstyle="->",facecolor='black'), fontsize=label_size)
...
ax4.text(206, 200, 'MX-0.1', color='black',horizontalalignment='center',verticalalignment='center', fontsize=label_size)
ax4.text(206, -800, 'MX-0.5', color='black',horizontalalignment='center',verticalalignment='center', fontsize=label_size)


plt.tight_layout()

ax1.set_title('a) O 1s',y=0.995,x=0.1,pad=-14)
ax2.set_title('b) Ti 2p',y=0.995,x=0.1,pad=-14)
ax3.set_title('c) F 1s',y=0.995,x=0.1,pad=-14)
ax4.set_title('d) Cl 2p',y=0.995,x=0.1,pad=-14)