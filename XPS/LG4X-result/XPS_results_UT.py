...
excel = '../Excel sheets/' + 'UT' + '.xlsx'
df = pd.read_excel(excel,sheet_name='0-wide')  
bind = df.iloc[1:,0].to_numpy()+0.6485 #Put C1s to 284.5 eV
...
ax[0,0].text(284.5, 460000, 'C1s', rotation=90, fontsize=12,horizontalalignment='center',verticalalignment='center')
ax[0,0].text(450, 140000, 'Ti2p', rotation=90, fontsize=12,horizontalalignment='center',verticalalignment='center')
ax[0,0].text(531, 120000, 'O1s', rotation=90, fontsize=12,horizontalalignment='center',verticalalignment='center')
ax[0,0].text(200, 30000, 'Cl2p', rotation=90, fontsize=12,horizontalalignment='center',verticalalignment='center')
ax[0,0].text(685, 120000, 'F1s', rotation=90, fontsize=12,horizontalalignment='center',verticalalignment='center')
...
bind, count, bg,sum_fit,residual, std_res = plot_xps('UT-O1s',0,1,400)
...
bind, count, bg,sum_fit,residual, std_res = plot_xps('UT-C1s',1,0,2000)
